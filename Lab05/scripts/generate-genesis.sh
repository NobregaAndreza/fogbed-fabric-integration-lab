...
# ============================================================
# Hyperledger Fabric - Genesis Block Generator (Lab05)
#
# Gera o bloco gênesis inicial utilizando `configtxgen`.
# Entrada: configtx.yaml, crypto-material/
# Saída: channel-artifacts/genesis.block
# ============================================================
...
echo "==========================================="
echo " Hyperledger Fabric - Genesis Block Builder (Lab05)"
echo "==========================================="
echo
...
if [ ! -d "${ROOT_DIR}/crypto-material" ]; then
    ...
    echo "Execute primeiro ./scripts/generate-crypto.sh"
    exit 1
fi
